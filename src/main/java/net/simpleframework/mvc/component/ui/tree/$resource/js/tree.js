...
TafelTree.prototype = {
  ...
  enableDropALT : function (alt) {
    this.dropALT = (alt) ? true : false;
  },

  enableDropCTRL : function (copy) {
  ...
  setDragScroll : function(dragScroll) {
    dragScroll = $(dragScroll);
    this.dragScroll = dragScroll ? dragScroll : false;
  },
